...
我是一名股票量化研究员，负责系统化股票投资、组合构建以及研究基础设施建设。我的工作长期围绕一个问题展开：

**投资想法如何最终转化为可投资的组合？**

这个问题贯穿整个研究流程——从原始数据、因子设计、预测模型，到组合构建，以及在真实交易约束下的评估与验证。

相比追求回测表现最大化，我更关注一个信号是否具有稳健性、可解释性，以及在真实投资环境中的可部署性。我相信解释性与结构性认知同样重要，好的研究系统应该让假设、依赖关系与中间过程保持可见，而不是隐藏在黑箱中，才能保证信号在样本外环境下的持续有效。

目前我居住于上海，就职于 Systematica Investments，从事股票 Alpha 研究。
...
除工作之外，我也在持续建设 **BagelQuant** —— 一个创新性的量化研究系统与知识库。

bagelquant基于计算图思想，将因子、信号、预测与组合逻辑抽象为Graph。能够
