...
alternate_lang_url: ../../../../../en/docs/core/reference/composers/less_equal.md
nav: docs_zh
---
...
```python
less_equal(lhs, rhs, name=None, metadata=None)
```

当第一个输入小于或等于第二个输入时返回一个，其他地方返回零。
...
from bagelquant_core.composer import less_equal
...
result = less_equal(left, right).compute().data
print(result)
```
