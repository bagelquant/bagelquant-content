...
alternate_lang_url: ../../../../../en/docs/core/reference/composers/less.md
nav: docs_zh
---
...
from bagelquant_core.composer import less
...
result = less(left, right).compute().data
print(result)
```
