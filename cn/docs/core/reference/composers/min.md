...
alternate_lang_url: ../../../../../en/docs/core/reference/composers/min.md
nav: docs_zh
---
...
```python
min(*frames, name=None, metadata=None)
```

[`minimum`](./minimum.md) 的别名。返回按元素排列的最小值。
...
from bagelquant_core.composer import min
...
result = min(left, right).compute().data
print(result)
```
