...
title: "minimum"
lang: en
ref: "docs-core-reference-composers-minimum"
alternate_lang_url: ../../../../../cn/docs/core/reference/composers/minimum.md
nav: docs_en
---
...
```python
minimum(*frames, name=None, metadata=None)
```
...
from bagelquant_core.composer import minimum
...
result = minimum(left, right).compute().data
print(result)
```
