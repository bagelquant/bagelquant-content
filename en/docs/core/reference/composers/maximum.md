...
alternate_lang_url: ../../../../../cn/docs/core/reference/composers/maximum.md
nav: docs_en
---
...
```python
maximum(*frames, name=None, metadata=None)
```
...
from bagelquant_core.composer import maximum
...
result = maximum(left, right).compute().data
print(result)
```
